...
function cadastrarAluno() {
    ...
    enviarRequisicao("POST", "/v2/cadastrarAluno", params, function(resp) {
...
function buscarAluno() {
    ...
    const url = "/v2/buscarAluno?nome=" + encodeURIComponent(nome);
...
function adicionarNota() {
    ...
    enviarRequisicao("POST", "/v2/adicionarNota", params, function(resp) {
...
function deletarAluno() {
    ...
    enviarRequisicao("POST", "/v2/deletarAluno", params, function(resp) {
