...
@WebServlet(name = "EditarItemServlet", value = "/EditarItemServlet")
public class EditarItemServlet extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(EditarItemServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String oldItemText = request.getParameter("oldItemText");
            String newItemText = request.getParameter("newItemText");
            ...
            boolean success = processor.updateItem(listaId, oldItemText, newItemText, feito, prioridade);

            if (success) {
                response.setStatus(HttpServletResponse.SC_OK);
                response.getWriter().write("Item atualizado com sucesso!");
            } else {
                response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Falha ao atualizar item");
            }
