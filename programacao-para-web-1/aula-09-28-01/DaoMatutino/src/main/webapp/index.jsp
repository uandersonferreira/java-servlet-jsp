...
<c:if test="${not empty mensagem}">
    ...
    <c:choose>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td class = "actions">
                            ...
                            <a href = "#" onclick = "confirmDelete(${produto.id})" class = "delete-btn"
	                            title = "Excluir">
            ...
            <c:otherwise>
                <p style="color: red; font-weight: bold;">Produto não encontrado!</p>
            </c:otherwise>
        </c:choose>
    ...
    <a href = "produtos" class = "add-btn">
        <i class = "fas fa-plus"></i>Todos Produtos
    </a>
